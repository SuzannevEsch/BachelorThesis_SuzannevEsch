...
output_excel_file = output_dir / "H2150_NI1_TWSO_WP_IRRTOT_PRTOT.xlsx"
...
def run_simulation(weather_file):
    ...
    agromanagement = YAMLAgroManagementReader(data_dir / "Agromanagement_2136_2165_no_irrigation1.agro")
